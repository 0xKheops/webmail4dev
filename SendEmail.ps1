...
$att = new-object Net.Mail.Attachment("./README.md")
Send-MailMessage -SmtpServer $smtp -To @($to, $randomPeon1) -From $from -Subject ($subject + $subject + $subject) -Body $body -BodyAsHtml -Priority high -UseSsl:$false -Cc @($randomPeon2, $randomPeon3)   -Bcc @($randomPeon4, $randomPeon5) -Attachments @("./README.md", "./start.js", "./screenshot.png")
