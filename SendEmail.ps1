...
Send-MailMessage -SmtpServer $smtp -To @($to, $randomPeon1) -From $from -Subject ($subject + $subject + $subject) -Body $body -BodyAsHtml -Priority high -UseSsl:$false -Cc @($randomPeon2, $randomPeon3)   -Bcc @("test@test.co") -Attachments @("./README.md", "./start.js", "./screenshot.png", "./client/src/assets/github.svg")
